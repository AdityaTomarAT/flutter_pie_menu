...
class PieTheme {
  ...
  double get hoverDisplacement => buttonSizeHeight / 8;
  ...
  PieTheme copyWith({
    ...
    double? buttonSizeHeight,
    double? buttonSizeWidth,
    double? pointerSize,
    ...
    return PieTheme(
      ...
      buttonSizeHeight: buttonSizeHeight ?? this.buttonSizeHeight,
      buttonSizeWidth: buttonSizeWidth ?? this.buttonSizeWidth,
